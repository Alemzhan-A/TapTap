...
const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="bg-transparent text-white absolute top-0 left-0 w-full z-50 pointer-events-none">
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="md:hidden bg-[#33334D] overflow-hidden pointer-events-auto"
            >
